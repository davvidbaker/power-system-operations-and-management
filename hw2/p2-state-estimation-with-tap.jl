...
function h(x)
    ...
    return [
        ...
        t * v_2 * v_1 * B_21 * sin(δ_2 - δ_1)
        -t * v_2 * v_1 * B_21 * cos(δ_2 - δ_1) + v_2^2 * B_21
    ]
...
for i in 1:num_iterations
    ...
    H = [-t*v_1*v_2*B_12*cos(δ_1 - δ_2) v_1*v_2*B_12*sin(δ_1 - δ_2)
        t*v_2*v_1*B_21*cos(δ_2 - δ_1) v_2*v_1*B_21*sin(δ_2 - δ_1)
        t*v_2*v_1*B_21*sin(δ_2 - δ_1) -v_2*v_1*B_21*cos(δ_2 - δ_1)
    ]
